...
// images being used
import detectImg from '../assets/images/detect-img.png';
import registerImg from '../assets/images/register-img.jpg';
import galleryImg from '../assets/images/gallery-img.jpg';
import vidImg from '../assets/videos/logo.mov';
import gallImg from '../assets/images/gallery.png';
            ...
            <Grid fluid>
                <Row>
                    <Col xs={12} md={12} style={{ 'textAlign': 'center' }}>
                     <h1>
                     <img className='logo' src={logoImg} alt="detect" width={350}/>
                     </h1>
                     <video source={vidImg}/>
                        <br />
                        ...
                        <p><b>Register. Recognize. Check.</b></p>
                        <br />
                    </Col>
                </Row>
                <Row>
                    ...
                    <Col xs={12} md={3} style={{ 'textAlign': 'center' }}>
                        <Card>
                            <CardMedia>
                                <img className='landingImage' src={gallImg} alt="gallery-face" />
                            </CardMedia>
                            <CardTitle title="Face Gallery" />
                            <CardText>
                                Deprecated for now due to API call limit but can be ensured upon purchase
                            </CardText>
                            <CardActions>
